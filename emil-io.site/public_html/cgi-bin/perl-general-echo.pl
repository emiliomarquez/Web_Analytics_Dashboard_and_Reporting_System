...
print <<END;
<!DOCTYPE html>
<html><head><title>General Request Echo</title><script src="./../collector.js"></script><link href="./../styles/checkDisabledCss.css" rel="stylesheet">
</head><body><div id="cssCheck"></div><img id="flag" src="./../images/clear.gif" alt=""><h1 align="center">General Request Echo</h1>
<hr>
END
